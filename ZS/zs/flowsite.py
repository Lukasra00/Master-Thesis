...
# Authors: Lukas Radtke {lradtke@caltech.edu}, Francesca Zhoufan-Li {fzl@caltech.edu}
# Contributions:
# - LR: code prototyping and initial implementation
# - FZL: code review and cleanup
# Date: 06/12/24
...
from Master_Thesis.ZS.global_param import ENZYME_INFO_DICT
from Master_Thesis.ZS.util import checkNgen_folder, calculate_ligand_centroid


FLOWSITE_MAIN_DIR = "/disk2/fli/FlowSite"
FLOWSITE_MODEL_PARAM_DIR = "/disk2/fli/FlowSite/model_params"

# residues_canonical_1letter from: https://github.com/HannesStark/FlowSite/blob/main/utils/featurize.py
